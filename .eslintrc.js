module.exports = {
    ...
    "env": {
      "browser": true,
      "es6": true,
      'node':true, // 要加这个不然当前eslintrc文件识别不了module.exports语法即commonjs语法
    },
    "extends": [
      "eslint:recommended",
    ...
    "rules": {
      ...
      "react/jsx-curly-spacing": [0, {"when": "always"}], // 在JSX属性和表达式中加强或禁止大括号内的空格。
      ...
      "react/no-multi-comp": 1, // 防止每个文件有多个class组件定义
